...
<div class="hero-card servicios-hero">
  <h3 class="hero-section-title">Servicios Disponibles en Toda la Región</h3>
  <div class="hero-divider"></div>
  <p class="hero-description" style="margin-bottom: 30px;">Como <strong>comercializadora industrial</strong> líder, ofrecemos:</p>
  
  <div class="servicios-list">
    <div class="servicio-item">✅ <strong>Importación y Exportación</strong> con seguimiento completo</div>
    <div class="servicio-item">✅ <strong>Logística Impo-Export</strong> especializada</div>
    ...
    <div class="servicio-item">✅ <strong>Soluciones financieras</strong> para proyectos</div>
